...
module.exports = {
	data: new SlashCommandBuilder().setName("stop").setDescription("The bot stops playing Music!"),
	async execute(interaction) {
		...
		musicqueue.length=0;
		console.log(`The Bot stopped playing! Stop Command! Here is the musicqueue: ${musicqueue[0]}`);
